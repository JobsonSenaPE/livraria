...
public class Categoria implements Serializable {
    ...
    @OneToMany(mappedBy = "categoria") //uma categoria para nenhum ou muitos livros - livro vai ser mapeado por alguma categoria.
                                       // livro não pode exitir sem uma categoria.
